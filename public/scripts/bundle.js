...
$(function(){
  ...
  function loadTweets(){
    $.ajax({
      ...
      var TweetComponents = require('./tweet-components')(data.user);
  ...
  loadTweets();
  console.log('After the load call');
...
},{"./tweet-components":2,"./utils/composer-char-counter":3}],2:[function(require,module,exports){
